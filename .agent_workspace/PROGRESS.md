...
Landed (exclusive; round still open): R6-10 `6fb7d9d` dead-letter pin; R6-8 SIGKILL run-lock probe (9×3); R6-6 cascade wire witness + `process-death`; R6-4 doctor `learnedState` inventory.
