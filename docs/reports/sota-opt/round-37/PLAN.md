...
**H — 已合入（空枚举；未铸造新面）**：[R37-H.md](./R37-H.md)。21 文件；基线 `fd437a9`。21 文件相对 `fd437a9` 四验 0 行；`wc -l` 1750。预算重锚默认链 8972/10307/9018 ns（宿主中窗，落历史包络）。**零**新站点级换名记录。S5-H-1 保持。**禁止**再编号为新 H 轴；**禁止**写入 EXCLUSIONS 表行。
