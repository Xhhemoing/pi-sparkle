...
本轮只接受排除表未覆盖、且理论+仿真达门槛的新更优解。禁止重开任何 X* / S1-* / S2-* / S3-* / S4-* / S5-* / S6-* / S7-* 条目，以及已合入的 S8-A-1..3 / S8-B-1..4 / S8-C-1..4。S7-C 已落地，不得另起平行实现。
...
状态：A/B/C 完成已合入（S8-A-1..3 / S8-B-1..4 / S8-C-1..4 淘汰）；D/E 运行中；F 本波派出。F 切片叠在 S7-F-1 + S7-F-2 之上，不要重开 S1-F-1..8 / S2-F-1..6 / S3-F-1..5 / S4-F-1..3 / S5-F-1..3 / S6-F-2..5 / S7-F-3..4，也不要重做 S1-F / S5-F / S6-F-1 / S7-F-1 / S7-F-2。S7-F-1 不是 S6-F-5。全实验锚点约 120–130 ms（P=2000/A=1000），不要硬凑。
