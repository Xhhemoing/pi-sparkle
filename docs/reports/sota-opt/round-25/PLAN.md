...
状态：第 1 波 A–C 已合入；第 2 波 D–F 已合入；第 3 波 F–H 已合入；第 4 波 I/J 运行中。Round 26 已开卷（A 本波派出）。
