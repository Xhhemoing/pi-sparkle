...
状态：第 1 波 A–C 已合入；第 2 波 D–F 已合入；第 3 波 G 已合入、H 运行中；第 4 波 I 运行中、J 本波派出。Round 24 已关闭。
