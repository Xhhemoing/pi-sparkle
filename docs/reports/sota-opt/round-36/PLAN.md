...
**目标**：在 R35 十切片诚实空枚举关闭（无 S35-A-* … S35-J-*；R35-A 三项换名检查拒列，未铸造新面；R35-G digest 第二十六次相同，未铸造 digest 轴号；R35-J 零新站点级换名记录、六个从未受控残余坐标未过三合取）以及 **FITQ / NAMESHAPE / SCALEX / XPROC / YMIX / SCHEDWIN / KFAN / NVG / SEEDX / TERMCLASS / SHAPEK / ORDX / CKMIX / CALLB / OCCX / JB / RUNLIM / VALCLASS / CG / AGEX / COTARG / PRICEX / RTL / DELINV / PROBX / RVL / SIDEC / PWL / ZREP / PAIRX / CSPELL / REPRX / LINKTOP / BINDX / MODEX** 具名 ban 的前提下，对十切片做**第三十六遍**独立枚举。R35 已 10/10 关闭。本轮状态：**A–J 已合入（10/10）**。Round 37 已开，见 [round-37/PLAN.md](../round-37/PLAN.md)。

**约束**：

- R8–R35 已合入切片全部诚实空枚举。无新 S35-A-* … S35-J-*。R36-A / R36-B / R36-C / R36-D / R36-E / R36-F / R36-G / R36-H / R36-I / R36-J 亦诚实空枚举关闭（无 S36-A-* … S36-J-*）。
...
| J | cluster 3 + privacy 3 + preferences 7 + episode 5 + persist 2 + track 4 + context 2 + feedback 3（29） | 已合入（空枚举；未铸造新面；preferences 132.0–267.2 / 412.4–534.9；jsonl 59.6–65.1 / fsync=true 240.5–380.2；J1 2468 / 2823.6×） |
...
**J — 已合入（空枚举；未铸造新面）**：[R36-J.md](./R36-J.md)。29 文件；基线 `fb41417`。29 文件相对 `fb41417` 四验 0 行；`wc -l` 3655。预算重锚 preferences 132.0–267.2 / 412.4–534.9；jsonl 59.6–65.1 / fsync=true 240.5–380.2（主机偏快，历史带交叠）。J1 2468 / 2823.6×。**零**新站点级换名记录。**禁止**再编号为新 J 轴；**禁止**写入 EXCLUSIONS 表行。
...
- Round 36 已 10/10 收口。Round 37 已开，本波派出 R37-A / R37-B / R37-C。
