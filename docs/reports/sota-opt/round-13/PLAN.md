...
Round 1–12 已对各区做过十二遍穷尽裁决，并落地 S1-F / J1 / S1-C / S1-I / S2-C / S3-C / S4-C / S4-I / S5-C / S5-F / S5-I-1 / S6-C / S6-F-1 / S7-C / S7-F-1 / S7-F-2 / S7-I-1。本轮只接受排除表未覆盖、且理论+仿真达门槛的新更优解。禁止重开任何 X* / S1-* … S12-* 条目（含已合入的 S12-B-1..2 / S12-C-1 / S12-D-1..2 与 R12-A / R12-E / R12-F / R12-G / R12-H / R12-I / R12-J / R13-A 的空枚举收口）。S7-C 已落地，不得另起平行实现。S7-F-1 不是 S6-F-5。
...
状态：第 2 波 D 本波派出；A 已合入（空枚举）；B/C 运行中。Round 12 已 10/10 收口。
...
D 切片 = 14 文件：`src/adaptation/`（promotion-rules / registry / eval-routing / promotion / active-pointer / monitor / retirement / approval-profile / resource / mutate / reflection / rollback / candidate / pareto）。不要重开 S1-D-* … S8-D-1..5 / S9-D-1..4 / S10-D-1..2 / S11-D-1..2 / S12-D-1..2。S9-D-4 便宜 `toLowerCase` skip 永不重开（U+212A fail-open）。S12-D-1 便宜形态同族。S12-D-2 eval 回放四遍融两遍为稳定负优化。禁止去 fsync / 完整性再哈希（S8-D-1..3 族）。eval 地板复核 3.72–4.07 ms。基线 `82bef36` 预期空 diff。
