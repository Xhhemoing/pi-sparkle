...
| 3 | 第 3–4 波进行中 | 10（2 在跑 / 7 完成 / 1 本波派出 / 0 排队） | claude-fable-5-thinking-xhigh | 落地 S3-C；[round-03/PLAN.md](./round-03/PLAN.md) |
...
| 3 | R3-G 运行时/图、R3-H 评价/需求 | G 完成已合入；H 在跑 |
| 4 | R3-I CLI/适配器、R3-J cluster/privacy | I 在跑；J 本波派出 |
