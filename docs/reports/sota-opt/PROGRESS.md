...
| 24 | 第 1–3 波进行中 | 3 / 10（A/B/C 已合入；D/E 运行中；F 本波派出） | claude-fable-5-thinking-xhigh | [round-24/PLAN.md](./round-24/PLAN.md) |
...
| R24-F | `cursor/r24-f-experiments-twenty-fourth-pass-83a1` | 已派出 |
