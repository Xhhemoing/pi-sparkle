...
| 3 | 第 1–3 波进行中 | 10（2 在跑 / 4 完成 / 1 本波派出 / 3 排队） | claude-fable-5-thinking-xhigh | 落地 S3-C；[round-03/PLAN.md](./round-03/PLAN.md) |
...
| 2 | R3-D 自优化、R3-E 学习、R3-F 实验 | D 完成已合入；E/F 在跑 |
| 3 | R3-G 运行时/图 | G 本波派出 |
