...
| 26 | 第 1–3 波进行中 | 4 / 10（A–D 已合入；E/F 运行中；G 本波派出） | claude-fable-5-thinking-xhigh | [round-26/PLAN.md](./round-26/PLAN.md) |
...
| 3 | R26-F 实验、R26-G 运行时/图 | F 运行中；G 本波派出 |
...
| R26-G | `cursor/r26-g-runtime-twenty-sixth-pass-83a1` | 已派出 |
