...
| 8 | 第 1 波进行中 | 3 / 10（A/B 运行中；C 本波派出，叠在 S7-C 上） | claude-fable-5-thinking-xhigh | [round-08/PLAN.md](./round-08/PLAN.md) |
...
| 波 | 区 | 状态 |
| --- | --- | --- |
| 1 | R8-A 跟踪门控、R8-B live 路由、R8-C 离线路由 | A/B 运行中；C 本波派出（叠在 S7-C 上） |
