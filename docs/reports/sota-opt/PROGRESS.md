...
| 27 | 第 1–4 波进行中 | 5 / 10（A–E 已合入；F/G 运行中；H 本波派出） | claude-fable-5-thinking-xhigh | [round-27/PLAN.md](./round-27/PLAN.md) |
...
| 3 | R27-F 实验、R27-G 运行时/图 | F/G 运行中 |
| 4 | R27-H 评价/需求 | H 本波派出 |
