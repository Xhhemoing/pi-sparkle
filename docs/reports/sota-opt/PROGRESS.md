...
| 20 | 第 1–2 波进行中 | 4 / 10（A 已合入；B/C 运行中；D 本波派出） | claude-fable-5-thinking-xhigh | [round-20/PLAN.md](./round-20/PLAN.md) |
...
| 波 | 区 | 状态 |
| --- | --- | --- |
| 1 | R20-A 跟踪门控、R20-B live 路由、R20-C 离线路由 | A 完成已合入；B/C 运行中 |
| 2 | R20-D 自优化 | D 本波派出 |
...
| R20-D | `cursor/r20-d-adaptation-twentieth-pass-83a1` | 已派出 |
