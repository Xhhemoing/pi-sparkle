...
| 28 | 第 1–8 波进行中 | 7 / 10（A–G 已合入；H 运行中；I 已派出；J 本波派出） | claude-fable-5-thinking-xhigh | [round-28/PLAN.md](./round-28/PLAN.md) |
...
| 5 | R28-G 运行时/图 | G 已合入 |
| 6 | R28-H 评价/需求 | H 运行中 |
| 7 | R28-I CLI/适配器 | I 已派出 |
| 8 | R28-J cluster/privacy | J 本波派出 |
...
| R28-H | `cursor/r28-h-eval-twenty-eighth-pass-83a1` | 已派出 |
