...
| 17 | 第 1–4 波进行中 | 8 / 10 已合入（A–H）；I/J 运行中 | claude-fable-5-thinking-xhigh | [round-17/PLAN.md](./round-17/PLAN.md) |
| 18 | 第 1 波进行中 | 1 / 10（A 本波派出） | claude-fable-5-thinking-xhigh | [round-18/PLAN.md](./round-18/PLAN.md) |
...
| 3 | R17-G 运行时/图、R17-H 评价/需求、R17-I CLI/适配器 | G/H 完成已合入；I 运行中 |
