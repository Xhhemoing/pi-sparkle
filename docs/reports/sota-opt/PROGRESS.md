...
| 2 | 第 3–4 波进行中 | 10（2 在跑 / 6 完成 / 2 排队） | claude-fable-5-thinking-xhigh | [round-02/PLAN.md](./round-02/PLAN.md) |
...
| 3 | R2-G 运行时/图、R2-H 评价/需求 | G/H 在跑 |
| 4 | R2-I CLI/适配器、R2-J cluster/privacy | I 本波派出；J 排队 |
