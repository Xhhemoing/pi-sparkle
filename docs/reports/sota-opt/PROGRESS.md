...
| 40 | 第 8 波进行中 | 9 / 10（A–I 已合入；J 本波派出） | claude-fable-5-thinking-xhigh | [round-40/PLAN.md](./round-40/PLAN.md) |
...
| R40-H | `cursor/r40-h-eval-fortieth-pass-83a1` | 已合入专属分支（仅 `R40-H.md`）。无新排除 ID；默认链复核 9134/9027/8907 ns（中间窗宿主）；零新站点级换名记录；S5-H-1 保持 |
