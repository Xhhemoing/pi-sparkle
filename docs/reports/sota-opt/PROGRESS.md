...
| 14 | 第 1–2 波进行中 | 5 / 10（A/B 已合入；C/D 运行中；E 本波派出） | claude-fable-5-thinking-xhigh | [round-14/PLAN.md](./round-14/PLAN.md) |
...
| 2 | R14-D 自优化、R14-E 学习 | D 运行中；E 本波派出 |
...
| R14-E | `cursor/r14-e-learning-fourteenth-pass-83a1` | 已派出 |
