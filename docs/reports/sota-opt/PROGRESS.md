...
| 27 | 第 1–5 波进行中 | 6 / 10（A–F 已合入；G/H 运行中；I 本波派出） | claude-fable-5-thinking-xhigh | [round-27/PLAN.md](./round-27/PLAN.md) |
...
| 3 | R27-F 实验、R27-G 运行时/图 | F 已合入；G 运行中 |
| 4 | R27-H 评价/需求 | H 运行中 |
| 5 | R27-I CLI/适配器 | I 本波派出 |
