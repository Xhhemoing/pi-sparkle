...
| 25 | 第 1–2 波进行中 | 2 / 10（A/B 已合入；C/D 运行中；E 本波派出） | claude-fable-5-thinking-xhigh | [round-25/PLAN.md](./round-25/PLAN.md) |
...
| 波 | 区 | 状态 |
| --- | --- | --- |
| 1 | R25-A 跟踪门控、R25-B live 路由、R25-C 离线路由 | A/B 已合入；C 运行中 |
| 2 | R25-D 自优化、R25-E 学习 | D 运行中；E 本波派出 |
...
| R25-D | `cursor/r25-d-adaptation-twenty-fifth-pass-83a1` | 已派出 |
| R25-E | `cursor/r25-e-learning-twenty-fifth-pass-83a1` | 已派出 |
