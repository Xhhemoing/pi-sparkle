...
| 32 | 第 1–6 波进行中 | 3 / 10（A–B、D 已合入；C 运行中；E 运行中；F 本波派出） | claude-fable-5-thinking-xhigh | [round-32/PLAN.md](./round-32/PLAN.md) |
...
| R32-C | `cursor/r32-c-offline-routing-thirty-second-pass-83a1` | 已派出 |
