...
| 16 | 第 1–3 波进行中 | 9 / 10（A–F 已合入；G/H 运行中；I 本波派出） | claude-fable-5-thinking-xhigh | [round-16/PLAN.md](./round-16/PLAN.md) |
...
| 3 | R16-G 运行时/图、R16-H 评价/需求、R16-I CLI/适配器 | G/H 运行中；I 本波派出 |
