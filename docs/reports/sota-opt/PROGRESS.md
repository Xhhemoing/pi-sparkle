...
| 26 | 第 1–3 波进行中 | 5 / 10（A–E 已合入；F/G 运行中；H 本波派出） | claude-fable-5-thinking-xhigh | [round-26/PLAN.md](./round-26/PLAN.md) |
...
| 3 | R26-F 实验、R26-G 运行时/图、R26-H 评价/需求 | F/G 运行中；H 本波派出 |
