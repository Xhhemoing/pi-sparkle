...
| 16 | 第 1–3 波进行中 | 8 / 10（A–E 已合入；F/G 运行中；H 本波派出） | claude-fable-5-thinking-xhigh | [round-16/PLAN.md](./round-16/PLAN.md) |
...
| 2 | R16-D 自优化、R16-E 学习、R16-F 实验 | D/E 完成已合入；F 运行中 |
| 3 | R16-G 运行时/图、R16-H 评价/需求 | G 运行中；H 本波派出 |
