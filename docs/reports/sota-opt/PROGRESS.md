...
| 33 | 第 1–4 波进行中 | 1 / 10（A 已合入；B/C/D 本波派出） | claude-fable-5-thinking-xhigh | [round-33/PLAN.md](./round-33/PLAN.md) |
...
| R33-D | `cursor/r33-d-adaptation-thirty-third-pass-83a1` | 已派出 |
