...
状态：第 1 波 A 本波派出。Round 21 H/J 仍在飞。
...
E 切片 = `src/learning/` 10 文件。不要重开 S8-E-1 / S9-E-2 / S13-B-1。R20-E bandit 并发与 R21-E 标识符几何不补铸。锚点 R21-E：15.8–16.9 / cmp20 17.8–18.5 µs/run。基线 `adb20d7` 预期空 diff。
...
H 切片 = 21 文件（evaluation **8**）。S5-H-1 必须保留。R20-H 环境进程态压力不补铸。热层默认 R20-H：9.24–9.36 µs/run。R21-H 在飞，勿触其分支。基线 `fd437a9` 预期空 diff。
...
J 切片 = 29 文件。J1 / S5-J-3 / S6-J-1 / S8-J-2 钉死。禁止去 fsync。R20-J 输入类组成不补铸。BYTESHAPE / NAMESHAPE / XPROC / SCHEDWIN 不要移植。R21-J 在飞，勿触其分支。若落地：重跑 J1（2468）+ r22j。基线 `fb41417` 预期空 diff。
