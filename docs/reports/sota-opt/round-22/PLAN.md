...
状态：第 1–2 波 A–E 已合入；第 3 波 F/G 运行中，H 本波派出。Round 21 已关闭。
...
F 切片 = `src/experiments/` 15 文件。**S7-F-1 不是 S6-F-5**。R20-F outcome 流组成与 R21-F 时钟输入面不补铸。R22-E **NVG** 与 R22-D 公开导出流普查不要移植到 F。锚点 R21-F：120.7–129.8 ms。若落地：重跑 r1f/r5f/r6f/r7f（2668 / 224 / 27 / 169）+ r22f。基线 `519101f` 预期空 diff。本波派出。
