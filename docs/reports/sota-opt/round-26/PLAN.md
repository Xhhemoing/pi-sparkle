...
状态：第 1 波 A 本波派出。Round 25 I/J 仍在飞。
...
B 切片 = live 路由 10 文件。Live = R0。不要重开 S12-B-2 / S13-B-1（重开条件未触发）。R25-B task-face optional-field presence topology 与 R24-B M=1 catalog collapse / R23-B batch arrangement / R22-B 标识符几何（G×T）不补铸。天花板 R25-B：M=2 9.06–9.29 / M=10 17.92–18.80 ms/eval。基线 `94ed3d9` 预期空 diff。

C 切片 = 离线路由 9 文件。必须站在 S1-C … S7-C。禁止再编号 ICOL / SFILL / ITERX / COLDX / AAFLR / GCAX / STORD / RIDGE / NSQRT / PMV / OSTZ / TAILG / REJX / **FITQ** / **SCALEX** / **YMIX** / **SEEDX** / **ORDX** / **OCCX** / **AGEX**。生产中位 R25-C：663.2–681.5 ms（正典 663.2–672.8）；APC ceiling 20.8–25.6 < 35；sink=7.309。若落地：重跑 r1c–r7c（8028 / 14420 / 14730 / 24888 / 28555 / 25483 / 6193）+ r26c。基线 `183df9b` 预期空 diff。
...
I 切片 = 25 文件。S8-I-1 两臂文件级 blocked。R24-I adaptation-state coordinate 与 R23-I `.pi/` 可观测树 / R22-I run-record 回读 / R21-I flowchart 平面不补铸。custom−builtin R24-I：children +44.2/+26.5、track +48.0/+25.9、flowchart-flat64 +48.7/+16.3 ms。若落地：重跑 r4i/r5i/r7i（68 / 119 / 80）+ r26i。基线 `8dee7fb` 预期空 diff。R25-I 若先合入，以其收口为准、勿补铸其轴。

J 切片 = 29 文件。J1 / S5-J-3 / S6-J-1 / S8-J-2 钉死。禁止去 fsync。R24-J **VALCLASS** 与 R23-J **CALLB** / R22-J **SHAPEK** / R21-J **KFAN** 不补铸。file-lock retryMs 已由 D/E 定价，勿作为 J ID 补铸。若落地：重跑 J1（2468）+ r26j。基线 `fb41417` 预期空 diff。R25-J 若先合入，以其收口为准、勿补铸其轴。
