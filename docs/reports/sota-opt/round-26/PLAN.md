...
状态：第 1 波 A/B 已合入、C 运行中；第 2 波 D 已合入、E 运行中；第 3 波 F 本波派出。Round 25 已关闭。
...
E 切片 = `src/learning/` 10 文件。不要重开 S8-E-1 / S9-E-2 / S13-B-1。R25-E **CG** 与 R24-E **JB** / R23-E GS / R22-E **NVG** 不补铸。R26-D injection-seam default-arm face / R26-A collation-locale face / R26-B privacy / provider-policy constraint-leg face 不要移植。SLICE-CPU R25-E：14.9–15.7 µs/run。基线 `adb20d7` 预期空 diff。运行中。

F 切片 = `src/experiments/` 15 文件。**S7-F-1 不是 S6-F-5**。R25-F plan-header identity-geometry face 与 R24-F state serialization-boundary provenance face / R23-F plan count-field 联合面 / R22-F membership-topology 不补铸。R26-D injection-seam default-arm face / R26-A collation-locale face / R26-B privacy / provider-policy constraint-leg face 不要移植。锚点 R25-F：r5f 121.25/130.67 / r6f 122.93 / r7f 127.56/130.12。若落地：重跑 r1f/r5f/r6f/r7f（2668 / 224 / 27 / 169）+ r26f。基线 `519101f` 预期空 diff。本波派出。
