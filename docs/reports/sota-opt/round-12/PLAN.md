...
状态：第 4 波收尾；A–H 已合入（A/E/F/G/H 空枚举；B 铸 S12-B-1..2；C 铸 S12-C-1；D 铸 S12-D-1..2，均淘汰）；I/J 运行中。第 13 轮已开，见 [round-13/PLAN.md](../round-13/PLAN.md)。
