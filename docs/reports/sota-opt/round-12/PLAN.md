...
状态：第 3 波 H 本波派出；A/B/C/D/E 已合入（A/E 空枚举；B 铸 S12-B-1..2；C 铸 S12-C-1；D 铸 S12-D-1..2，均淘汰）；F/G 运行中。
