...
- [ ] Close P0: dictionary exists at [data-dictionary.md](../docs/data-dictionary.md) (17 classes after the 2026-08-22 completeness audit); independent privacy review has no blocker. Reviewer walk-through package: [2026-08-22-p0-privacy-review-package.md](../docs/reports/2026-08-22-p0-privacy-review-package.md) — answer Q1–Q5 there, then record the decision here.
